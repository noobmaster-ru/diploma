...
% Нумерация разделов включена для корректной работы счётчиков и гиперссылок
...
%Настройка верхнего колонтитула (пустой)
\makeevenhead{standart}{}{}{}
\makeoddhead{standart}{}{}{}

%Настройка нижнего колонтитула (номер по центру)
