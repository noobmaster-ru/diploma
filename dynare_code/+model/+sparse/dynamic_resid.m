...
residual(4) = y(18)*y(11)*(1-y(19))+y(13)*y(16)+y(17)*y(2)-y(14)*y(18)-y(18)*y(15);
residual(5) = y(11)-T(3)*T(13);
residual(6) = y(2)/y(13)-y(16)/y(17)*T(4);
residual(7) = y(19)-T(5)*T(6);
residual(8) = 1-params(7)+y(19)*params(7)/y(18)-T(7)*params(8)*(T(7)-1)+T(10)*T(11);
residual(9) = y(11)-y(14)-y(15);
