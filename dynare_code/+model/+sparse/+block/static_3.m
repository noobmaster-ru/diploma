...
if nargout > 3
    g1_v = NaN(27, 1);
g1_v(1)=(-((-y(6))/(y(8)*y(8))));
g1_v(2)=y(1)*(1-y(9))-y(4)-y(5);
g1_v(3)=(-(y(9)*params(7)))/(y(8)*y(8));
g1_v(4)=T(3)*params(6)*getPowerDeriv(y(3),params(5),1);
g1_v(5)=y(6);
g1_v(6)=(-(T(5)*getPowerDeriv(y(3),1-params(1),1)));
g1_v(7)=(-y(2))/(y(3)*y(3));
g1_v(8)=y(8)*(1-y(9));
g1_v(9)=1;
g1_v(10)=1;
g1_v(11)=y(7);
g1_v(12)=(-(T(4)*y(10)*getPowerDeriv(y(2),params(1),1)));
g1_v(13)=1/y(3);
g1_v(14)=1-(1-params(3));
g1_v(15)=(-(1/y(8)));
g1_v(16)=y(3);
g1_v(17)=(-(params(1)/(1-params(1))*1/y(7)));
g1_v(18)=(-(T(6)*1/(1-params(1))*getPowerDeriv(y(6)/(1-params(1)),1-params(1),1)));
g1_v(19)=(-(y(8)*y(1)));
g1_v(20)=1;
g1_v(21)=params(7)/y(8);
