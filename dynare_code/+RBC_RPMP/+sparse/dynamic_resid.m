...
residual(5) = y(20)-T(4)*T(17);
residual(6) = y(2)/y(22)-y(25)/y(27)*params(1)/(1-params(1));
residual(7) = y(31)-T(6)*T(7);
residual(8) = 1-params(7)+y(31)*params(7)/y(35)-T(8)*params(8)*(T(8)-1)+T(11)*y(39)/y(20);
    residual(9) = (y(33)) - (y(20)*(y(35)-y(31))-y(20)*y(35)*T(12));
residual(10) = y(20)-y(23)-y(24)-y(20)*T(12);
    residual(11) = (y(36)) - (T(8));
    residual(12) = (log(y(37))) - (params(9)*log(y(18))-x(1));
    residual(13) = (y(29)/params(16)) - (T(14)*T(15));
