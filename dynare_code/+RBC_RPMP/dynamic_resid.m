...
residual(5) = y(6)-T(4)*T(17);
residual(6) = y(1)/y(8)-y(11)/y(13)*params(1)/(1-params(1));
residual(7) = y(17)-T(6)*T(7);
residual(8) = 1-params(7)+y(17)*params(7)/y(21)-T(8)*params(8)*(T(8)-1)+T(11)*y(25)/y(6);
    residual(9) = (y(19)) - (y(6)*(y(21)-y(17))-y(6)*y(21)*T(12));
residual(10) = y(6)-y(9)-y(10)-y(6)*T(12);
    residual(11) = (y(22)) - (T(8));
    residual(12) = (log(y(23))) - (params(9)*log(y(4))-x(it_, 1));
    residual(13) = (y(15)/params(16)) - (T(14)*T(15));
