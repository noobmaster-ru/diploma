...
residual=NaN(8, 1);
  ...
  residual(2)=(y(8)*y(1)*(1-y(9))+y(3)*y(6)+y(7)*y(2)-y(4)*y(8)-y(5))-(0);
  T(4)=y(3)^(1-params(1));
  ...
  residual(7)=(y(8)*y(1)-y(4)*y(8)-y(5))-(0);
...
g1_v(3)=(-y(8));
g1_v(4)=(-((-y(6))/(y(8)*y(8))));
g1_v(5)=y(1)*(1-y(9))-y(4);
g1_v(6)=(-(y(9)*params(7)))/(y(8)*y(8));
g1_v(7)=y(1)-y(4);
g1_v(8)=y(7);
...
g1_v(16)=(-(1/y(8)));
g1_v(17)=y(3);
g1_v(18)=(-(params(1)/(1-params(1))*1/y(7)));
g1_v(19)=(-(T(6)*1/(1-params(1))*getPowerDeriv(y(6)/(1-params(1)),1-params(1),1)));
g1_v(20)=(-(y(8)*y(1)));
g1_v(21)=1;
g1_v(22)=params(7)/y(8);
g1_v(23)=y(8)*(1-y(9));
g1_v(24)=1;
g1_v(25)=y(8);
g1_v(26)=(-1);
